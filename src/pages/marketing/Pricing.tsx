...
import {
  CreditCard, Monitor, Send, BarChart3, CheckCircle2, Star, Gift, Zap,
  Sparkles, ArrowLeft, MessageCircle, Users, Eye
} from "lucide-react";
...
const plans = [
  {
    ...
    badge: null,
    features: [
      "קבלת מתנות באשראי מכל מקום",
      "קישור אישי לשליחה לאורחים",
      "צפייה בעסקאות ובברכות בזמן אמת",
    ],
  ...
  },
  {
    ...
    badge: "🔥 מומלץ",
    features: [
      "עמדת טאץ' באירוע עצמו",
      "אפשרות לשלוח מתנות במקום",
      "הגדלת משמעותית של כמות המתנות",
    ],
    gradient: "from-yellow-500/15 to-primary/10",
  ...
  },
  {
    ...
    badge: null,
    features: [
      "שליחה מרוכזת בוואטסאפ ובמייל",
      "מעקב אחרי אישורי הגעה",
      "סדר מלא ברשימת האורחים",
    ],
    gradient: "from-blue-500/10 to-secondary/5",
...
const faqs = [
  { q: "מתי מקבלים את הכסף?", a: "בהתאם לתנאי הסליקה — בדרך כלל תוך מספר ימי עסקים לאחר ביצוע העסקה." },
  { q: "האם חייב לקחת את כל השירותים?", a: "לא, בוחרים רק מה שמתאים. כל שירות עומד בפני עצמו." },
  { q: "אפשר להתחיל בלי לשלם?", a: "כן! פתיחת אירוע עם ניהול תקציב היא ללא עלות. אפשר להוסיף שירותים בכל שלב." },
  { q: "איך זה עובד עם עמדה באולם?", a: "אנחנו מספקים עמדת טאבלט שמוצבת באולם האירועים. האורחים ניגשים ושולחים מתנה תוך שניות." },
  { q: "האם יש התחייבות?", a: "ללא התחייבות. משלמים חד פעמי לכל אירוע ומשתמשים בשירות." },
];
      ...
      <section className="relative pt-32 pb-20 overflow-hidden bg-gradient-to-b from-secondary via-secondary/95 to-secondary/90">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          <h1 className="text-4xl md:text-6xl font-bold text-white mb-6 leading-tight">
            ...
            <span className="text-primary">ומתחילים להרוויח מהאירוע</span>
          </h1>
      ...
      <section className="py-16 bg-primary/5">
        <div className="container mx-auto px-4 text-center max-w-3xl">
          ...
          <h2 className="text-2xl md:text-3xl font-bold text-secondary mb-4">
            זה מחזיר את עצמו מהר מאוד
          </h2>
          <p className="text-lg text-muted-foreground leading-relaxed mb-4">
            תוספת של מתנה אחת או שתיים מכסה את העלות —<br />
            <span className="font-bold text-primary">ומשם הכל רווח</span>
          </p>
          <p className="text-sm text-muted-foreground/70">
            מספיק תוספת של מתנה אחת–שתיים כדי להחזיר את העלות
          </p>
        </div>
      </section>
